 ...
 * @Last modified time: Tuesday, 26th February 2019 4:14:06 pm
 * @License: All Rights Reserved
 * @Copyright: Copyright XY | The Findables Company
 */

import { IConsensusProvider, IRequest, ISignatureComponents, IResponse, IConsensusBlock, IRewardComponents } from './@types'
...
export class XyoScscConsensusProvider extends XyoBase implements IConsensusProvider {
  ...
  public getRewardPercentages(): Promise<IRewardComponents> {
    throw new Error("Method not implemented.")
  }

  public getLatestBlock(): Promise<IConsensusBlock | undefined> {
    throw new Error("Method not implemented.")
  }

  public getLatestBlockHash(): Promise<BigNumber> {
    throw new Error("Method not implemented.")
  }

  public getRequestById(id: BigNumber): Promise<IRequest | undefined> {
    throw new Error("Method not implemented.")
  }
